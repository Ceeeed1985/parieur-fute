<section class="left w-[30%] flex flex-col">
    ...
    <section class="btn-vers-site bg-gray-800 text-white mt-3 px-5 py-3 rounded flex items-center hover:cursor-pointer group">
        <a href="{{route('home')}}" class="pr-2 font-semibold text-lg">Vers le site</a>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
             class="size-6 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
